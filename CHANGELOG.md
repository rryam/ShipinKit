...
- Updated GitHub Actions to Node 24-compatible releases, pinned each remaining action
  by commit, and replaced the stale Emerge wrapper with its current upload contract.
