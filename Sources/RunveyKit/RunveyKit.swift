...
public struct RunveyKit {
    ...
    ///   }
    ///   ```
    public func generateVideo(prompt: String, imageURL: URL, duration: VideoDuration = .short, aspectRatio: AspectRatio = .widescreen, watermark: Bool = false, seed: Int? = nil) async throws -> URL {
        logger.info("Starting video generation")
